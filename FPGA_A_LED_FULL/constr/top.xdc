...
## -------------------------
## LEDs: show final pred_class[3:0]
## -------------------------
## LED0 -> led_result[0]
set_property PACKAGE_PIN R14 [get_ports {led_result[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {led_result[0]}]

## LED1 -> led_result[1]
set_property PACKAGE_PIN P14 [get_ports {led_result[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {led_result[1]}]

## LED2 -> led_result[2]
set_property PACKAGE_PIN N16 [get_ports {led_result[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {led_result[2]}]

## LED3 -> led_result[3]
set_property PACKAGE_PIN M14 [get_ports {led_result[3]}]
