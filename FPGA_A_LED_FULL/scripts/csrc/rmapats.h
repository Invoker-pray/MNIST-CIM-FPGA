...
extern "C" {
#endif
void  hs_0_M_0_0__tb_mnist_cim_demo_a_top_led_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_0__tb_mnist_cim_demo_a_top_led_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_2_0__tb_mnist_cim_demo_a_top_led_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_3_0__tb_mnist_cim_demo_a_top_led_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_4_0__tb_mnist_cim_demo_a_top_led_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_5_0__tb_mnist_cim_demo_a_top_led_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_6_0__tb_mnist_cim_demo_a_top_led_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_7_0__tb_mnist_cim_demo_a_top_led_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_8_0__tb_mnist_cim_demo_a_top_led_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_9_0__tb_mnist_cim_demo_a_top_led_simv_daidir (UB  * pcode, scalar  val);
