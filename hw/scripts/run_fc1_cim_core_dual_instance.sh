...
vcs -full64 -sverilog -timescale=1ns/1ps \
	...
	${RTL_DIR}/fc1_cim_core_dual_instance.sv \
	${TB_DIR}/tb_fc1_cim_core_dual_instance.sv \
	2>&1 | tee ${SIM_DIR}/log/compile_tb_fc1_cim_core_dual_instance.log

${SIM_DIR}/fc1_cim_core_dual_instance_simv \
	+INPUT_HEX_FILE=${INPUT_HEX} \
	+WEIGHT_HEX_FILE=${WEIGHT_HEX} \
	+FC1_ACC_FILE=${FC1_ACC_HEX} \
	+FC1_BIAS_FILE=${FC1_BIAS_HEX} \
	2>&1 | tee ${SIM_DIR}/log/sim_tb_fc1_cim_core_dual_instance.log
