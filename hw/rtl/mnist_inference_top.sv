...
module mnist_inference_top #(
    parameter string DEFAULT_INPUT_HEX_FILE = "../route_b_output/input_0.hex",
    parameter string DEFAULT_FC1_WEIGHT_HEX_FILE = "../route_b_output/fc1_weight_int8.hex",
    parameter string DEFAULT_FC1_BIAS_HEX_FILE = "../route_b_output/fc1_bias_int32.hex",
