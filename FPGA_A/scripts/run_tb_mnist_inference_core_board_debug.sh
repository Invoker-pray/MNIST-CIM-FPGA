...
vcs -full64 -sverilog -timescale=1ns/1ps \
	-debug_access+all \
	-o ${SIM_DIR}/tb_mnist_inference_core_board_debug_simv \
	...
	${TB_DIR}/tb_mnist_inference_core_board_debug.sv \
	2>&1 | tee ${SIM_DIR}/log/compile_tb_mnist_inference_core_board_debug.log

${SIM_DIR}/tb_mnist_inference_core_board_debug_simv \
	2>&1 | tee ${SIM_DIR}/log/sim_tb_mnist_inference_core_board_debug.log
